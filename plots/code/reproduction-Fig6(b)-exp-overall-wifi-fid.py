...
reproduction_data_root = os.path.join(data_root, "reproduction_fid_wifi.mat")
overall_rot_file = os.path.join(data_root, "exp_overall_fid_wifi.mat")
# sigma = scio.loadmat(overall_rot_file)["data_wifi_sigma"]
sigma = scio.loadmat(reproduction_data_root)["repro_fid"]
...
plt.tight_layout()
# plt.show()
plt.savefig(save_root + "/reproduction-Fig6(b)-exp-overall-wifi-fid.pdf", dpi=800)
