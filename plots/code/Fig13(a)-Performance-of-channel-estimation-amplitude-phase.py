...
(amplitude_line1,) = ax1.plot(
    range(1, 27), amplitude, linewidth=1.2, label="Uplink", color="#084E87"
)
(amplitude_line2,) = ax1.plot(
    range(1, 27), amplitude2, linewidth=3, alpha=0.8, label="Downlink", color="#ef8a00"
)
(amplitude_line3,) = ax1.plot(
    range(1, 27), amplitude3, linewidth=1.2, label="Predict", color="#BF3F3F"
)
...
(phase_line1,) = ax2.plot(
    range(1, 27), phase, linewidth=1.2, label="Uplink", color="#084E87"
)
(phase_line2,) = ax2.plot(
    range(1, 27), phase2, linewidth=3, alpha=0.8, label="Downlink", color="#ef8a00"
)
(phase_line3,) = ax2.plot(
    range(1, 27), phase3, linewidth=1.2, label="Predict", color="#BF3F3F"
)
...
ax2.legend(
    handles=[phase_line1, phase_line2, phase_line3],
    loc="lower left",
    prop={"size": 6},
    ncol=3,
    edgecolor="black",
