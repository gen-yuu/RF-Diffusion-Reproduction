...
reproduction_data_root = os.path.join(data_root, "reproduction_ssim_wifi.mat")
sigma = scio.loadmat(reproduction_data_root)["repro_ssim"]
...
plt.tight_layout()
# plt.show()
plt.savefig(save_root + "/reproduction-Fig6(a)-exp-overall-wifi-ssim.pdf", dpi=800)
